...
% remove rows where visit_age < 18
demos_drugs_matched(demos_drugs_matched.visit_age<18,:)=[];
...
%%
save NCANDA_all_data_18plus.mat demos_drugs_matched SC outliers TS TS_interp TS_gsr TS_gsr_interp sri124

%%

save NCANDA_SC_18plus.mat SC
%%
...
save NCANDA_FCgsr_18plus.mat FC

%% 

save NCANDA_demos_18plus.mat demos_drugs_matched